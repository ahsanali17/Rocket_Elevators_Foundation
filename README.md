...
5. SendGrid
    ...
    For the our required purposes the endGrid API allows us the ability to create autogenerated emails that can be sent to user/clients who sign up or complete forms on Roccket Elevators.  
